...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('pause')
        .setDescription('Stops music playback that is currently running on this server.')
    ...
    async execute(interaction, client) {
        ...
        return interaction.reply({
            embeds: [new EmbedBuilder()
                .setDescription(`Successfully stopped playing music that was running on this server.`)
                .setColor(config.embed.color)], ephemeral: true
        }).then(async () => {
